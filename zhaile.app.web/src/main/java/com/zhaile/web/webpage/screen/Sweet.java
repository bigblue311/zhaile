...
public class Sweet extends DefaultLayout {
	...
	public void execute(@Param("page") Integer page,
    	...
    	cache.getAdvertisementcache().click(cache.getAdvertisementcache().getAd(30).getId());
    	
    	context.put("menuN","30");
    	context.put("pageTarget","sweet");
