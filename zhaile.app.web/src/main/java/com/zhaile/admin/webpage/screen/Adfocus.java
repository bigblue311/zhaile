...
public class Adfocus extends AdminLoginFilter {
	...
	public void execute(@Param("command") String command,Context context,Navigator nav) throws IOException{
		...
		List<Integer> adPlist = Lists.newArrayList(2,3,4,5,6);
		...
		context.put("title", "五屏滚动");
		context.put("hasLink", true);
		context.put("allowedWidth", 836);
		context.put("allowedHeight", 281);
		context.put("previewWidth", 209);
		context.put("previewHeight", 70);
